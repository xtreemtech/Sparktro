...
watch(() => page.url, (newUrl) => {
    if (newUrl.startsWith('/users')) {
        userMenuOpen.value = true;
    } else {
        userMenuOpen.value = false;
    }

    if (newUrl.startsWith('/role-permission')) {
        rolePermissionMenuOpen.value = true;
    } else {
        rolePermissionMenuOpen.value = false;
    }

    if (newUrl.startsWith('/profile')) {
